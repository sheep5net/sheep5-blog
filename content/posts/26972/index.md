...
images = ['og-image.jpg']
description = "今天把博客改成静态博客了，用的是hugo。之前博客一直放在Wordpress，.org和.com都试过，但是最后都放弃了。Wordpress的问题太多了，不仅需要一台独立的服务器，而且用起来麻烦，服务器每年还要续一笔不小的费用。"
+++
